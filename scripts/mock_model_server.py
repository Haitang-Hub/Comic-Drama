...
# ==================== 预设返回内容（全新故事：小猫咪花花迷路寻家） ====================

# Phase-5 新格式：三段式输出，SummaryStepHandler.parseSummaryContent 按分隔符解析。
# 正/负面提示词（英文）写入 story_summary，供步骤 4/5/6 图像模型复用。
SUMMARY_CONTENT = (
    "小猫咪花花是个好奇宝宝。一天午后，她在花园里追蝴蝶，越跑越远，最后发现自己迷路了。"
    "她穿过高高的花丛，遇到一只忙碌的小蜜蜂，蜜蜂告诉她顺着月亮的方向走就能回家。"
    "花花鼓起勇气，在月光下找到了熟悉的小路，终于回到了温暖的小窝。"
)
...
# 第1条：追蝴蝶迷路；第2条：月亮指引回家。
STORYBOARD_CONTENT = (
    "1|6|1|1|中景|花花在花园中追蝴蝶，蝴蝶飞走，她停下环顾四周|花园_原版|花花_原版|蝴蝶结_原版|"
    "花花在午后阳光下追逐一只彩蝶，蝴蝶翩翩飞过花丛，花花蹦跳着追赶，忽然蝴蝶消失，她停下脚步，"
    "茫然地看着周围陌生的花丛|花花：咦？蝴蝶去哪儿了？我这是在哪里呀？|"
    "阳光明媚的花园，五彩花朵盛开，蝴蝶飞舞，小猫咪花花竖着尾巴，一脸困惑地四处张望\n"
    "2|6|1|2|近景|花花抬头望向月亮，沿着月光小路前行|花园_原版|花花_原版|蝴蝶结_原版|"
    "夜幕降临，月亮升起，花花想起蜜蜂的话，抬头看了看月亮，鼓起勇气，沿着洒满月光的小路向前走，"
    "终于看到远处熟悉的屋檐|花花：月亮先生，请带我回家吧！|"
    "夜晚的花园，月光洒下银辉，小猫咪花花的剪影在月光下显得坚定，远处隐约可见一个温暖的小屋灯光"
)
...
ASSET_DESIGN_CONTENT = (
    "人物|花花_原版|花花|无|橘色小猫咪，圆脸大眼，脖子上系着红色蝴蝶结，活泼可爱，尾巴高高翘起|1\n"
    "人物|花花_月光版|花花|花花_原版|同样的橘色小猫咪，但眼睛在月光下显得更亮，神情坚定，"
    "身上沾了些草叶和花瓣，略显疲惫但充满希望|2\n"
    "场景|花园_原版|花园|无|午后阳光下的美丽花园，盛开着各种颜色的花朵，绿草如茵，有蝴蝶和蜜蜂飞舞，"
    "远处有高大的树木|1\n"
    "道具|蝴蝶结_原版|蝴蝶结|无|鲜红色的蝴蝶结，系在花花脖子上，丝绒材质，中央有金色圆点装饰，大小适中|1\n"
    "音色|花花|花花|无|清脆甜美的少女音，语调活泼，略带稚嫩，适合小猫咪的形象|1"
)
