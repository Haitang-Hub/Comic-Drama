...
SUMMARY_CONTENT = (
    "小雨是一位安静的图书馆管理员。某个午后，她在整理旧书堆时发现一封泛黄的神秘信件，"
    "信中藏着一段关于隐藏古籍的线索。好奇心驱使她踏上寻书之旅，在书架间穿梭寻找答案。"
    "她按照信中指引来到三楼尽头的旧书架，终于在角落找到一本封皮磨损的古旧书籍，"
    "翻开书页，泛黄的纸页上写满了前人留下的笔记，一段跨越时光的往事逐渐浮现。"
)

# ==================== 修改点：由 1 条分镜扩展为 2 条分镜 ====================
...
# 时长=6 对应测试约定（duration=6s）。
# 第2条分镜沿用相同场景/角色/道具，序号递增，local_seq 顺延。
STORYBOARD_CONTENT = (
    "1|6|1|1|中景|小雨翻阅旧书时指尖碰到异物停下动作|图书馆_原版|小雨_原版|神秘信件_原版|"
    "小雨在午后的图书馆里整理旧书，指尖在书页间翻动，忽然碰到一个硬物，低头一看是封泛黄的信件|"
    "小雨：咦，这是什么？夹在书里好久了……看起来有些年头了。|午后阳光斜洒进旧图书馆的窗户，"
    "空气中漂浮着细小的尘埃，木质书架高耸林立，小雨戴着眼镜站在书架前，手中拿着一本厚重的旧书，"
    "另一只手捏着一封泛黄的信件，脸上露出好奇的表情\n"
    "2|6|1|2|近景|小雨将信封凑近眼前，仔细观察火漆印章|图书馆_原版|小雨_原版|神秘信件_原版|"
    "小雨将信封举到眼前，仔细查看封口的暗红色火漆印章，发现上边刻着模糊的符号|"
    "小雨：这印章上的花纹……好像在哪里见过。|小雨的特写镜头，信封上的火漆印章占据画面中心，"
    "她眉头微蹙，眼神专注，手指轻抚印章边缘，身后的书架虚化处理"
)
# ========================================================================
...
ASSET_DESIGN_CONTENT = (
    "人物|小雨_原版|小雨|无|年轻女性，齐耳短发，戴圆框眼镜，穿米白色素色衬衫，气质温和文静，面带淡淡的微笑|1\n"
    "人物|小雨_针织衫|小雨|小雨_原版|同样的年轻女性小雨，但场景切换到傍晚，灯光下她换上了深蓝色针织开衫，发丝略显蓬松，神情更显专注认真|2\n"
    "场景|图书馆_原版|图书馆|无|午后阳光洒落的旧图书馆，高耸的深棕色木质书架整齐排列，空气中漂浮着细小的尘埃颗粒，复古台灯半明半暗|1\n"
    "道具|神秘信件_原版|神秘信件|无|泛黄的牛皮纸信封，封口处有一枚褪色的暗红色火漆印章，边缘因年代久远微微卷曲，信纸边角略有磨损|1\n"
    "音色|小雨|小雨|无|柔和清亮的年轻女性嗓音，语速适中，咬字清晰，语气中带着一丝天然的好奇与温柔|1"
)
